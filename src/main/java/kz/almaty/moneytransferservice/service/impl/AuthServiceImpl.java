...
import kz.almaty.moneytransferservice.model.Role;
import kz.almaty.moneytransferservice.model.User;
import kz.almaty.moneytransferservice.repository.RoleRepository;
import kz.almaty.moneytransferservice.repository.UserRepository;
import kz.almaty.moneytransferservice.security.JwtTokenProvider;
...
public class AuthServiceImpl implements AuthService {
    ...
    public String register(RegisterDto registerDto) {
        if (userRepository.existsByUsername(registerDto.getUsername())) {
            throw new GlobalApiException(HttpStatus.BAD_REQUEST, "Username is already exists!");
        }
        if (userRepository.existsByEmail(registerDto.getEmail())) {
            throw new GlobalApiException(HttpStatus.BAD_REQUEST, "Email is already exists!");
        }
        User user = new User();
